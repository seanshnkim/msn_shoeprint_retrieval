...
class DefaultDataset(Dataset):
    def __init__(self, config, data_type):
        self.data_dir = os.path.join("FID-300", config["data_path"][data_type])
...
#         self.data_dir = os.path.join("FID-300", config["data_path"]["query_test"])
#         self.data_list = sorted(os.listdir(self.data_dir))
...
#         self.data_dir = os.path.join("FID-300", config["data_path"]["ref_test"])
#         self.data_list = sorted(os.listdir(self.data_dir))
